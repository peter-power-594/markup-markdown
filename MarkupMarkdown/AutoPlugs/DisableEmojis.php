...
final class DisableEmojis {
	...
	public function __construct() {
		...
		if ( mmd()->exists( WP_PLUGIN_DIR . '/disable-emojis/disable-emojis.php' ) ) :
	 ...
	 * @return Void
	 */
	final public function disable_front_emojis() {
	 ...
	 * @return Void
	 */
	final public function disable_back_emojis() {
	 ...
	 */
	final public function disable_emojis_tinymce( $plugins ) {
		if ( is_array( $plugins ) ) :
	 ...
	 * @return Array The difference betwen the two arrays.
	 */
	final public function disable_emojis_remove_dns_prefetch( $urls, $relation_type ) {
